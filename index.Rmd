...
```
This plot shows the number of listings that are in each neighborhood in Washington, D.C.. Capitol Hill, Lincoln Park has the most listings with almost 610 
...
```
This graph shows the spread of minimum number of nights required by listings in Washington.
