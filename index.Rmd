...
abnb %>%
  ...
  coord_flip() 
#graph is flipped for easier viewing
```
...
```
The analysis of variance produced a p-value smaller than 0.05.Because of this, we can reject the null hypothesis of no relation for price and the time of year. We will run this test two more times, to see if there is a relationship between room type and price and price and neighborhood.
...
```
From our analysis we can see that we can not reject our mull hypothesis of whether there is a relationship between price and neighbourhoods. The pvalue we obtained in the analysis above is greater than 0.05 and therefore we shall not reject our null hypothesis.
